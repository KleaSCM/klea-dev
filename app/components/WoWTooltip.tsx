 ...
 * 
 * Creates a beautiful tooltip inspired by World of Warcraft item tooltips
 * Features:
 ...
 * @param {boolean} props.isVisible - Whether tooltip should be visible
 * @param {Object} props.position - Tooltip position {x, y}
 * @returns {JSX.Element} WoW-style tooltip
 */
...
const WoWTooltip = ({ project, isVisible, position }: WoWTooltipProps) => {
