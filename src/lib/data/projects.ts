export interface Project {
  ...
  // Dynamic content fields from TEMPLATE.md
  benchmarks?: string[];
  prerequisites?: string[];
  installation?: (string | { title?: string; code?: string; language?: string; value?: string; description?: string })[];
  usage?: (string | { title?: string; code?: string; language?: string; value?: string; description?: string })[];
  contact?: string[];
  futurePlans?: string[];
  ...
  performanceStats?: Record<string, string> | {
    metrics: Array<{ label: string; value: string; description?: string }>;
    benchmarks?: Array<{ test: string; result: string; unit: string }>;
  };
  codeSnippets?: Record<string, { title?: string; code?: string; value?: string; explanation?: string; description?: string; language?: string }> | Array<{
    title: string;
    description: string;
    language: string;
    code: string;
